...
( function( $ ) {
	...
	function initHomepageNav(){
		...
		$('<div/>', {
		    'id' : 'slideNav'
		}).append($('<ul><li class="slideNavPrev"><a class="disabled" href="#" title="Slide anterior"><span class="ico ico-up"><img src="img/cima.png" alt="cima" style="max-width: 31px;"></span></a></li><li><span id="activeSlide" style="opacity:0;">'+activeSlide+'</span>Slide<span id="maxSlides" style="opacity:0;">'+slidesCount+'</span></li><li class="slideNavNext"><a href="#" title="Slide seguinte"><span class="ico ico-down"><img src="img/baixo.png" alt="baixo" style="max-width: 31px;"></span></a></li></ul>')).appendTo('body').delay(1200).fadeIn(duration);
